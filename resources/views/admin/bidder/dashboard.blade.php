                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ route('bidder.info') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="text" name="agent_name" class="form-control has-feedback-left"
                                        id="inputSuccess2" placeholder="የህጋዊ ወኪል ስም">
                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="text" name="citizenship" class="form-control" id="inputSuccess3"
                                        placeholder="ዜግነት">
                                    <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="email" name="company_email" class="form-control has-feedback-left"
                                        id="inputSuccess4" placeholder="የድርጅቱ ኢሜል">
                                    <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="number" name="company_ph" class="form-control" id="inputSuccess5"
                                        placeholder="የድርጅቱ ስልክ">
                                    <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="number" name="tin_number" class="form-control has-feedback-left"
                                        id="inputSuccess5" placeholder="Tin ቁጥር">
                                    <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="number" name="tax_id_num" class="form-control" id="inputSuccess5"
                                        placeholder="የታክስ መለያ ቁጥር">
                                    <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="number" name="trade_license_reg_num"
                                        class="form-control has-feedback-left" id="inputSuccess5"
                                        placeholder="የንግድ ፍቃድ ምዝገባ ቁጥር">
                                    <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <div>
                                <p>
                                    <h5><small><u>የቴክኒክ ብቃት ማስረጃ</u></small>
                                        <ul>
