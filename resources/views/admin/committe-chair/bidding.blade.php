...
<div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="#" class="site_title"> <img src="{{asset('build/images/bdu_logo.png')}}" width="30px"
                            height="30px"> <span>Tender System</span></a>
                </div>
        ...
        <div class="right_col" role="main">
            <div class="x_panel">
                <div class="x_title">
                    <h3> Committe Chair Dashboard </h3>
                </div>
                        ...
                        <div class="profile_details">
                            <div class="well profile_view">
                                ...
                                <div class="left col-md-4 text-center">
                                    <img src="{{asset('images/logos/'. $bidderFile->company_logo_url) }}"
                                        alt="{{ asset('build/images/user.png') }}" class="img-circle img-fluid">
                                    company logo
                                </div>
                                <div class="right col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-building"></i> የድርጅቱ ስልክ ቁጥር : {{ $bidderFile->company_ph}}
                                        </li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btn btn-info"
                                                href="{{ route('download',['name'=>$results->files])}}"><i
                                                    class="fa fa-download"></i> Download File</a></td>
                                        <td><button class="btn btn-success"><i class="fa fa-folder"></i> Open</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="col-md-6">
                    <div class="x_panel">
                        ...
                        <div style="margin-left:60px">
                            <div class="col-md-7">
                                <h5>የውክልና ማስረጃ የቴክኒክ ብቃት ማስረጃ</h5>
                                <p>
                                    <h6>ጨረታውን ለፈጸመው ሰው የተሰጠ ህጋዊ የውክልና ማስረጃ</h6>
                                    <h6>የቴክኒክ ብቃት ማረጋገጫ ሰነድ<br />
                                        ባለፉት አመታት የተፈጸሙ አጥጋቢ ኮንትራቶች</h6>
                                </p>
                                @foreach ($otherBidderFiles as $otherBidderFile)
                                <a class="btn btn-primary"
                                    href="{{ route('otherDownload',['name'=>$otherBidderFile->doc_name])}}"><i
                                        class="fa fa-download"></i>{{ $otherBidderFile->doc_name }}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
    ...
    // url = "{{url('stock/chart')}}";
         ...
         /*  var chartdata={
           $.get(null, function(response){
            ...
            var point1= parseInt(<?php echo $technical->point; ?>);
